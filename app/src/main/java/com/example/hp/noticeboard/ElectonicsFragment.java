 ...
 */
public class ElectonicsFragment extends Fragment {
    final static String urlAddress="http://10.0.2.2/android/app/electronics.php";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView= inflater.inflate(R.layout.electonics_layout,null);
